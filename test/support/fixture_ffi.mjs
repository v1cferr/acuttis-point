...
//
// The sign-in flag goes in sessionStorage because that is where Acuttis keeps
// its token — and storageState does NOT capture sessionStorage, so restoring it
// takes an init script. Using localStorage here would pass a test the real site
// would fail.
